            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  onClick={() => trackNavigation(t('nav.destinations'), 'footer')}
                >
                  {t('nav.destinations')}
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="text-sm text-gray-400 hover:text-white transition-colors"
                  onClick={() => trackNavigation(t('nav.vehicles'), 'footer')}
                >
                  {t('nav.vehicles')}
                </Link>
              </li>
        ...
        <div className="py-6 border-t border-navy-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <div className="flex items-center gap-4">
              <p>© 2025 Jetset Transfers. {t('footer.rights')}</p>
              <span>•</span>
              <Link
                href="/admin/login"
            ...
            <div className="flex items-center gap-4">
              <span className="flex items-center gap-2">
                ...
                {locale === 'es' ? 'Servicio 24/7' : '24/7 Service'}
              </span>
              <span>•</span>
