...
const categoryConfig = {
  hero: {
    ...
    fields: [
      { key: 'hero_title', label: 'Título principal', placeholder_es: 'Transporte Privado en', placeholder_en: 'Private Transportation in' },
      { key: 'hero_subtitle', label: 'Subtítulo destacado', placeholder_es: 'Cancún y Riviera Maya', placeholder_en: 'Cancún & Riviera Maya' },
      { key: 'hero_description', label: 'Descripción', placeholder_es: 'Descripción del servicio...', placeholder_en: 'Service description...' },
      { key: 'hero_badge', label: 'Badge/Etiqueta', placeholder_es: '5+ años de experiencia', placeholder_en: '5+ years of experience' },
    ],
  },
  services: {
    label: 'Servicios',
    ...
    tips: 'Títulos y descripciones para las secciones de Destinos y Zonas de Servicio.',
    fields: [
      { key: 'services_title', label: 'Título de sección', placeholder_es: 'Nuestros Servicios', placeholder_en: 'Our Services' },
      { key: 'destinations_title', label: 'Título Destinos', placeholder_es: 'Destinos Populares', placeholder_en: 'Popular Destinations' },
      { key: 'destinations_description', label: 'Descripción Destinos', placeholder_es: 'Traslados a los mejores destinos...', placeholder_en: 'Transfers to the best destinations...' },
      { key: 'zones_title', label: 'Título Zonas', placeholder_es: 'Zonas de Servicio', placeholder_en: 'Service Areas' },
      { key: 'zones_description', label: 'Descripción Zonas', placeholder_es: 'Cobertura en toda la Riviera Maya...', placeholder_en: 'Coverage across the Riviera Maya...' },
    ],
  },
  about: {
    label: 'Nosotros',
    ...
    fields: [
      ...
      { key: 'about_experience', label: 'Experiencia', placeholder_es: '5+ años de servicio', placeholder_en: '5+ years of service' },
    ],
  },
  contact: {
    label: 'Contacto',
    ...
    fields: [
      ...
      { key: 'contact_subtitle', label: 'Subtítulo', placeholder_es: '¿Listo para tu traslado?', placeholder_en: 'Ready for your transfer?' },
  ...
  footer: {
    ...
    fields: [
      { key: 'footer_description', label: 'Descripción', placeholder_es: 'Transporte privado desde el aeropuerto...', placeholder_en: 'Private transportation from the airport...' },
  ...
  seo: {
    ...
    fields: [
      { key: 'meta_title', label: 'Título Meta', placeholder_es: 'Jetset Transfers - Transporte Privado', placeholder_en: 'Jetset Transfers - Private Transportation' },
      { key: 'meta_description', label: 'Descripción Meta', placeholder_es: 'Transporte privado y traslados...', placeholder_en: 'Private transportation and transfers...' },
    ],
  },
  other: {
    label: 'Otros',
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    placeholder={getCategoryConfig(formData.category || 'other').fields?.find(f => f.key === formData.key)?.placeholder_es || 'ej: Transporte privado en Cancún...'}
                    className="w-full px-3 py-2 bg-navy-800 border border-navy-700 rounded-lg text-white placeholder-navy-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    placeholder={getCategoryConfig(formData.category || 'other').fields?.find(f => f.key === formData.key)?.placeholder_en || 'ej: Private transportation in Cancún...'}
                    className="w-full px-3 py-2 bg-navy-800 border border-navy-700 rounded-lg text-white placeholder-navy-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
                  />
                </div>
              </div>
